			...
			if(uSearch.isEmpty()){
				...
				if(rSearch.isEmpty()){
					...
					if(aSearch.isEmpty()){
						...
						Key k=KeyFactory.createKey(Users.class.getSimpleName(),Long.parseLong(request.getParameter("userId")));
						Users u = pm.getObjectById(Users.class, k);
						request.setAttribute("user", u);
						k=KeyFactory.createKey(Roles.class.getSimpleName(),u.getIdRole());
